...
public static class ApiConfig
{
    ...
    /// installer actually ships — hit the real deployed backend. If the Fly app name
    /// in fly.toml changes, update the URL below to match.
    /// </summary>
#if DEBUG
    public const string BaseUrl = "http://localhost:5137/";
#else
    public const string BaseUrl = "https://agc-launcher-server.fly.dev/";
#endif
}
